    ...
    def load_cameras_from_db(self):
        ...
        for serie, info in camaras.items():
            ...
            if info.get('monitoreando'):
                self.cam.iniciar_monitoreo_movimiento(serie, intervalo=5, callback_evento=None)

    def get_camaras_activas(self):
        return self.cam.camaras_activas

    def tomar_fotografia(self, serie: str):
...
class CameraController:
    ...
    def load_cameras_from_db(self):
        ...
        Si alguna cámara está marcada como 'monitoreando' en la DB, inicia su monitoreo.
