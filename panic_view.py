...
class PanicView:
    ...
    def __init__(self, parent, root, logic, camara_manager=None, styles=None):
        self.parent = parent
        self.root = root
        self.logic = logic
...
• Asegúrese de tener contactos de emergencia configurados en la pestaña "Contactos"
    ...
    def activar_panico(self):
        ...
        try:
            ...
            # Activar alarma física en Raspberry Pi Pico
            if self.camara_manager:
                self.camara_manager.activar_alarma(serie="Sistema")

            self.notifier.notificar_contactos(contactos, tipo_alerta="PÁNICO")
    ...
    def activar_alarma_silenciosa(self):
        ...
        try:
            ...
            self.notifier.notificar_contactos(contactos, tipo_alerta="SILENCIOSA")
